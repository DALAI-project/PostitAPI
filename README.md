...
-|-|-|-|-
Post-it|3456|431|431|98.60%
No post-it|41 377|5133|4829|99.83%

The model has been trained and tested using 55 657 scanned document images, out of which 4318 images contain post-it notes. With a test set of over 5 500 images, the model reaches over 98% detection accuracy for both classes. 
...
`/postitpath` endpoint expects to receive the filepath to the image as a query parameter.
...
`curl http://127.0.0.1:8000/postitpath?path=/path/img.jpg`
...
`curl http://127.0.0.1:8000/postitpath?path=/data/img.jpg`
